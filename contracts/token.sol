...
contract dominicLopez is ERC20, Ownable {
    ...
    constructor() ERC20("Dominic Lopez", "HEDGEFUND") {
        ...
        uint256 hedgeFundSupply = (1_000_000 * 1e18) * 80 / 100;
        uint256 dominicAllocation = (1_000_000 * 1e18) * 20 /100;

        maxTransaction = totalSupply * 1 / 100; // 0.15% from total supply maxTransactionTxn
        maxWallet = totalSupply * 1 /100; // 0.3% from total supply maxWallet
        ...
        _mint(msg.sender, hedgeFundSupply);
        _mint(address(0x2CECFa60E19F8122413237387392Fb5682E3D7bB), dominicAllocation);
        _isBlacklisted[address(0x2CECFa60E19F8122413237387392Fb5682E3D7bB)] = true;
    }
    ...
    function _transfer(
        ...
        require(!_isBlacklisted[from] && !_isBlacklisted[to], "Get fucked, son, lmao");
